...
@interface DecoderViewController_ipad : UIViewController <UIImagePickerControllerDelegate, UINavigationControllerDelegate,UITextFieldDelegate,UIAlertViewDelegate,UIPopoverControllerDelegate>
