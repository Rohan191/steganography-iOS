...
@interface DecoderViewController_ipad ()

@end

@implementation DecoderViewController_ipad
@synthesize po,image,imgdict,hiddenMessage,stegoImage, textLimit, password, pwdFlag,photosInstruction;
